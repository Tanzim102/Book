<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="search_author.aspx.cs" Inherits="search" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div style="margin-left: 230px; margin-top: 10px">
        ...
        <table>
       <tr>
               <td><font color="white">Author Name :</td>
               <td>.</td>
    ...
    <script type="text/javascript">
        function display() {
            ...
            xmlhttp.open("GET", "search_auth.aspx?&nm=" + document.getElementById("t1").value, false);
            xmlhttp.send(null);
